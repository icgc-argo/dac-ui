...
export const BackgroundBubble = ({ isPdf = false }: { isPdf?: boolean }) => {
  ...
  return (
    <GenericContainer>
      ...
      <UnorderedListComponent>
        <ListComponent asListItem>What founding research is your project based on?</ListComponent>
  ...
  return (
    <GenericContainer>
      ...
      <UnorderedListComponent>
        ...
        <ListComponent asListItem>How exactly will the ICGC Controlled Data be used?</ListComponent>
        <ListComponent asListItem>
