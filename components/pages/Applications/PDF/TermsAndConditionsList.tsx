  ...
  ({ count }: { count: number }) => (
    <ListComponent count={count}>
      ...
      <TextComponent as="span">
        ...
        DISCONTINUATION OF AVAILABILITY OF ANY OR ALL OF THE ICGC CONTROLLED DATA, OR, (C) ANY
        UNANTICIPATED OR UNSCHEDULED DOWNTIME OF ALL OR A PORTION OF THE ICGC CONTROLLED DATA FOR
        ANY REASON. IN NO EVENT SHALL THE UNIVERSITY'S LIABILITY UNDER THIS AGREEMENT EXCEED AMOUNTS
